...
<div>
  ...
  <ul v-if="!loading" class="list-group">
    <li class="list-group-item text-right">
      <button @click="order" type="button" v-if="lessons.length > 0" class="btn btn-success">
        Order
      </button>
    </li>
          ...
          <div class="col-xs-10">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <button @click="get(item.Id)" type="button" data-toggle="modal" data-target="#lesson-edit" class="btn btn-default" title="Edit">
    ...
    <li class="list-group-item">
        ...
        <div class="input-group">
            <input v-model="newEntry.Name" type="text" class="form-control" placeholder="New lesson">
            <span class="input-group-btn">
